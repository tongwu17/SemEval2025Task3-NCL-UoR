...
model_name = "occiglot/occiglot-7b-es-en-instruct"
...
file_path = "catalan_questions.tsv"
...
for shorthand, config in tqdm.tqdm(configs):
    output_file_path = f'outputs/catalan-{model_name.split("/")[1]}.{shorthand}.jsonl'
    anootation_file_path = f'outputs/catalan-{model_name.split("/")[1]}-annotation.{shorthand}.jsonl'
