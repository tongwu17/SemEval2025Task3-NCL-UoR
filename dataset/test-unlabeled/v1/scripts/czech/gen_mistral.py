...
for shorthand, config in tqdm.tqdm(configs):
    output_file_path = f'outputs/with_logits/czech-{model_name.split("/")[1]}.{shorthand}.jsonl'
    anootation_file_path = f'outputs/4annot/czech-{model_name.split("/")[1]}-anotation.{shorthand}.jsonl'
